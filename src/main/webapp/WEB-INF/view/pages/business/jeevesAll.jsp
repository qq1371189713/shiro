...
<div class="top" id="top">
	<div class="top-div">
	    <div class="div-cell">
	    	<div class="cell">
	    		<div class="cell1" style="background-color: #8bffff;">占道中任务 <span id="count4">10</span></div>
	    	</div>
	    </div>
	    <div class="div-cell">
	    	<div class="cell">
	    		<div class="cell1" style="background-color: #ffe0a3;">今日待占道任务 <span id="count5">10</span></div>
	    	</div>
	    </div>
	    <div class="div-cell">
	    	<div class="cell">
	    		<div class="cell1" style="background-color: #ffa1ac;">预警中的任务 <span id="count6">10</span></div>
	    	</div>
	    </div>
	 </div>
</div>
