 ...
 <div id="map" class="container">
	<div class="top" id="top">
		<div class="top-div">
		    <div class="div-cell">
		    	<div class="cell">
		    		<div class="cell1" style="background-color: #8bffff;">占道中任务 <span id="count1"></span></div>
		    	</div>
		    </div>
		    <div class="div-cell">
		    	<div class="cell">
		    		<div class="cell1" style="background-color: #ffe0a3;">今日待占道任务 <span id="count2"></span></div>
		    	</div>
		    </div>
		    <div class="div-cell">
		    	<div class="cell">
		    		<div class="cell1" style="background-color: #ffa1ac;">预警中的任务 <span id="count3"></span></div>
		    	</div>
		    </div>
		 </div>
	</div>
                	...
                	<div class="layui-form" lay-filter="search">
                		<div class="layui-form-item">
                			<div class="layui-input-inline" style="width:120px;">
                				<input type="text" id="searchText1" name="searchText" class="layui-input" maxlength="15" placeholder="占道编号/路段">
                			</div>
                			...
                			<div class="layui-input-inline" style="width:78px;">
		                		<select id="state1" name="state">
			                		...
			                		<option value="1" selected="selected">占道中</option>
...
<div id="up-map-div1" style="display: none;">
	...
	<div class="top1" id="top1" style="display: none;">
		<div class="layui-form" lay-filter="search1" style="float:right;margin-top: 20px; margin-right:20px;">
			<div class="layui-form-item">
				<div class="layui-input-inline" style="width: 120px;">
					<input type="text" id="searchText2" name="searchText" class="layui-input" maxlength="15" placeholder="占道编号/路段">
				</div>
				<div class="layui-input-inline" style="width: 90px;">
					<input type="text" id="time2" name="time" class="layui-input"
						placeholder="-时间-">
				</div>
				<div class="layui-input-inline" style="width: 78px;">
				...
				<div class="layui-input-inline" style="width: 90px;">
					<button class="layui-btn layui-btn-primary layui-btn-sm clearBtn" id="clearBtn1">重置</button>
...
<%-- <script type="text/javascript" src="<%=basePath%>/resources/tools/CricleDymaic.js"></script> --%>
